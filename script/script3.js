...
var numero=prompt("Ingrese un numero entre el 1 al 10  ");
if (numeroAdivinable == numero)
	{
		document.write("Felicidades!!!!  Has adivinado el numero " + numeroAdivinable );
	} 
else 
	{
		document.write("<h3>Error!!! El numero adivinable es:  "+ numeroAdivinable+" . Y tu ingresaste  " + numero);
	}
